...
<br/>
**V3.0.3 release-notes tickets:** [Jira query](https://jira.iguazeng.com/issues/?jql=labels%20in%20(RN-3.0.3%2C%20RN-3.0.3-fixes%2C%20RN-3.0.3-known-issues%2C%20RN-3.0.3-TechPreview)){{< comment >}}<!-- `v3.0.3_RN_done` filter (#13603)  -->
...
- Support Spot instances for EKS 
- Support Azure Kubernetes Service (AKS) 
- Node Selector to assign MLRun jobs and functions to specific nodes
- Support GCP GPU machine types
{{< comment >}}
(JN 19-aug-2021 - this was commented out because the feature was pulled from v3.0.3.)
- Support Linux Unified Key Setup (LUKS) encryption
{{< /comment >}}
-->
<!-- //////////////////////////////////////// -->
