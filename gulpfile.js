...
function init() {
  ...
  relDocsHomeUrl = configBuild.buildType.local.relDocsHomeURL;
    ...
    // public doc-site home page and to the development staging doc-site home
    // page for internal builds; (I don't use the staging URL for external
    // builds because the link is also used in offline doc-site builds, which
...
gulp.task('generate-hugo-data-vars-file', [], function() {
  ...
  content += '\n';
  content += '## Relative doc-site home URL for the current build\n';
...
// doc-site directory ($relDocsHomeURL), which contains the versioned doc
...
// the doc-site repo and edited them for versioned doc-site redirects. However,
...
// versioned doc site, and the versioned doc-site .htaccess files are currently
