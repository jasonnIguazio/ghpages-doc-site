########################################
## URL Redirects - docs-dev staging versioned doc site
...
# begin with `https://igzdocsdev.wpengine.com/docs-dev/$1/`.

#///////////////////////////////////////
## Removed and Relocated Pages Redirects

# Architecture intro page (initially filtered out temporarily,)
RedirectMatch 301 ^/([^/]+)/intro/architecture(|/.*)$ https://igzdocsdev.wpengine.com/docs-dev/$1
...
RedirectMatch 301 ^/([^/]+/tutorials/getting-started/trial-qs/)overview(|/.*)$ https://igzdocsdev.wpengine.com/docs-dev/$1$2

# Additional-resources" tutorials GS page (moved to an introduction section)
RedirectMatch 301 ^/([^/]+)/tutorials/getting-started/(additional-resources)(|/.*)$ https://igzdocsdev.wpengine.com/docs-dev/$1/intro/introduction/#$2
